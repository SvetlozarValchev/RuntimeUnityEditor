...
namespace RuntimeUnityEditor.Utils
{
    public static class EditorUtilities
    {
        ...
        {
            Debug.Log("[CheatTools] Looking for Transforms...");
        ...
        {
            Debug.Log("[CheatTools] Looking for Root Game Objects...");
        ...
        {
            Debug.Log("[CheatTools] Looking for MonoBehaviours...");
        ...
        {
            Debug.Log("[CheatTools] Looking for Components...");
        ...
        {
            Debug.Log("[CheatTools] Looking for class instances...");
